...
| :-------- | :--------| :-- |:--------|--------:| --------:|
| access_token  | 维修厂账户Token | 维修厂账户授权Token | string  | 是 | 无 |
| order_no | 采购单编号| 16位的采购单编号  | string | 是 | 无|


**请求实例**：
```json
http://api.weipei.cc/v1/motor-repair-shop/purchase-order-detail?access_token=3e16cdaa0061ee89106b9112890a419397b46f1s&order_no=561dbc6ca96af
```
**返回结果**：
```json
{
