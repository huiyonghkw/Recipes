...
**请求资源**：/token
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/token
**请求参数**：
...
|exipiry_time|过期时间，时间戳|int|10|



###2.***发送手机验证码***
**接口说明**：客户端提交手机号码到服务器, 服务器则向该手机号码发送一条带4位数字的手机验证码，有效期为10分钟。10分钟内不断请求接口，都只会返回一个相同的手机验证码。请限制1分钟内只允许发送一次手机验证码。
**请求资源**：/mobile_verification_code
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/mobile_verification_code
...
**请求资源**：/verification
**请求方式**：PUT
**请求地址**：http://api.weipei.cc/v1/verification
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求资源**：/account
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/account
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| verification_code  | 验证码  | 手机短信验证码    | int(4)  | 是 | 无 |
| realname  | 真实用户名  | 真实用户名   | int(4)  | 否 | 无 |
...
**请求资源**：/avatar
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/avatar
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求资源**：/upgrade
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/upgrade
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求资源**：/password
**请求方式**：PUT
**请求地址**：http://api.weipei.cc/v1/password
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| verification_code  | 手机验证码 | 手机验证码   | int(4)  | 是 | 无 |
...
**请求资源**：/account_information
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/account_information
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求实例**：
```http
http://api.weipei.cc/v1/account_information?access_token=555b2fd1fd99a5fa70ff1c203c673d68e040894b
```
**返回结果**：
```json
{
...
**请求资源**：/account_password
**请求方式**：PUT
**请求地址**：http://api.weipei.cc/v1/account_password
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求资源**：/login
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/login
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求资源**：/favorites
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/favorites
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| :-------- | :--------| :-- |:--------|--------:| --------:|
| access_token  | 授权token | 授权token   | sring  | 是 | 无 |
| accessory_shop_id  | 配件商编号 | 系统返回的配件商ID  | int(11)  | 是 | 无 |
...
**请求资源**：/favorites/me
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/favorites/me
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| limit  | 限制大小 | 指定返回记录的数量，系统会做验证    | int | 否 | 100 |
| offset  | 偏移量 | 指定返回记录的开始位置    | int  | 否 | 0 |


**请求实例**：
```json
http://api.weipei.cc/v1/favorites/me?access_token=3e16cdaa0061ee89106b9112890a419397b46f12&limit=100&offset=0
```
**返回结果**：
```json
{
...
|accessory_shop_id|配件商编号| int| -|
|accessory_shop_name|配件商名称| int| -|
|accessory_shop_address|配件商详细地址| string| -|
|accessory_shop_brands|配件商主营品牌列表| -| -|
|brand_name|配件商主营品牌名称| string| -|
|realname_authentication|实名认证， 1=已通过认证 0-未通过认证| int| 1|
|weipei_authentication|微配认证 1=已通过认证 0-未通过认证| int| 1|


###13.***筛选配件商***
**接口说明**：通过省市区/车型品牌，车系等信息查询配件商信息
**请求资源**：/accessory_shops
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/accessory_shops
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：

| 参数名      |含义   | 规则说明  | 参数类型 | 是否必须 | 缺省值 |
| :-------- | :--------| :-- |:--------|--------:| --------:|
| city_id  | 城市编号 | 系统返回的城市ID  | int  | 否 | 无 |
| automobile_brand  | 品牌 | 系统返回的车型品牌ID  | int | 否 | 无 |
...
**请求实例**：
```json
http://api.weipei.cc/v1/favorites?city_id=1&title=对方答复&automobile_brand=1&limit=100&offset=0
```
**返回结果**：
```json
{
...
| 参数名      |含义   | 规则说明  | 参数类型 | 是否必须 | 缺省值 |
| :-------- | :--------| :-- |:--------|--------:| --------:|
| accessory_shop_id  | 配件商编号 | 系统返回的配件商ID  | int  | 是 | 无 |
...
|favorites_status|收藏状态 0-未收藏过 1-已收藏| int| -|
|total_quotation_sheets|配件商总共报价单| int| -|
|total_shipped_orders|配件商总共已发货采购单| int| -|
|accounts|账号信息|- | -|
|account_id|账号ID|int| -|
|username|用户名|string|-|
|mobile|手机号码|int|11|
...
**请求资源**：/motor-repair-shop/inquiry-sheet
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/motor-repair-shop/inquiry-sheet
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| automobile_brand  | 品牌编号 | 系统返回的品牌ID  | int  | 是 | 无 |
| automobile_series  | 车系编号 | 系统返回的车系ID  | int  | 是 | 无 |
| automobile_model  | 车型编号 | 系统返回的车型ID  | int  | 是 | 无 |
| appearance_image_id  | 车型外观图片 | 车型外观图片系统编号  | int  | 否 | 无 |
| vin_image_id  | VIN图 | VIN图系统编号  | int | 否 | 无 |
| notes  | 备注  | 备注信息  | string  | 否 | 无 |
| accessory_item | 配件条目编号  | 正常情况是填写配件类目ID,  如果不是ID, 请传入配件名称  | string | 否 | 无 |
| accessory_item_image | 配件图片  | 配件附件ID,请先走上传图片接口  | int | 否 | 无 |
...
| 返回参数 |含义| 参数类型 | 长度 |
|:--|:--|--:|--:|
|inquiry_sheet_id|询价单编号| int| -|



###16.***获取配件类目***
**接口说明**：配件商或者修理厂通过省市区/车型品牌，车系等信息查询配件商信息
**请求资源**：/accessories-items
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/accessories-items
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求实例**：
```json
http://api.weipei.cc/v1/accessories-items?title="default"&parent=0&limit=100&offset=0
```
**返回结果**：
```json
{
...
###17.***修理厂询价单详情***
**接口说明**：修理厂获取询价单基础信息
**请求资源**：/motor-repair-shop/inquiry-sheet-detail
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/motor-repair-shop/inquiry-sheet-detail
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| :-------- | :--------| :-- |:--------|--------:| --------:|
| access_token  | 服务商账户Token | 服务商账户授权Token | string  | 是 | 无 |
| inquiry_sheet_id  | 询价单编号 | 系统返回的询价单ID  | int  | 是 | 无 |
...
|automobile_brand_id|品牌编号| int| -|
|automobile_series_id|车系编号| int| -|
|automobile_model_id|车型编号| int| -|
|notes|配件名称| string| -|
|appearance|车型外观图| string| -|
|appearance_id|车型外观编号| int| -|
|vin_id|vin图编号| int| -|
|vin|vin图| string| -|
|status|状态, 0待处理 2已报价 3未报价 4已结束| int| -|
|status_string|状态说明 | string| -|
|created_at|创建时间 | string| -|
|exipiry_time|过期时间|int|10|
|server_time|服务器当前时间戳|int|10|
|updated_at|更新时间|string|-|
|total_quoted|总报价数| int| -|
|motor_repair_shop_id|维修厂编号| int| -|
...
|total_inquiry_sheets|维修厂总共询价单| int| -|
|total_shipped_orders|维修厂已发货的采购单| int| -|
|accounts|账号信息|- | -|       
|account_id|账号ID|int| -|
|username|用户名|string|-|
|mobile|手机号码|int|11|
...
|inquiry_sheet_accessory_item_id|询价单配件条目ID| int| -|
|accessory_item_id|配件编号| int| -|
|accessory_item_name|配件名称| string| -|
|accessory_item_image|配件图片| string| -|
|accessory_shops|配件商报价列表|- | -|
|quotation_sheet_id|报价单编号|int | -|
|accessory_shop_id|配件商系统编号| int| -|
|accessory_shop_name|配件商名称| string| -|
...
###18.***配件商创建报价单***
**接口说明**：配件商提交报价
**请求资源**：/accessory-shop/quotation-sheet
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/accessory-shop/quotation-sheet
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| inquiry_sheet_id | 询价单编号 | 系统返回询价ID  | int | 是 | -|
| inquiry_sheet_accessory_item_id | 询价配件编号| 询价配件编号    | int  | 是 | 无 |
| accessory_item_id | 配件编号| 系统返回的配件编号    | int  | 是 | 无 |
| inquiry_sheet_accessory_items | 配件条目| 配件条目   |-  |- | - |
| price | 价格  | 报价价格，支持两位小数  | float  | 是 | 无 |
| accessory_level | 配件级别  | 配件级别 | int  | 是 | 无 |
| accessory_quality_gurantee_period | 质保期  | 配件质保期  | int  | 是 | 无 |
| accessory_arrival | 到达情况  | 到达情况  | int  | 是 | 无 |
...
###19.***修理厂询价列表***
**接口说明**：修理厂的所有询价列表信息汇总。
**请求资源**：/motor-repair-shop/inquiry-sheet-lists
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/motor-repair-shop/inquiry-sheet-lists
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| unexpired  | 未过期标识 | 1=>未过期 0=>全部 | int | 否 | 0 |
| limit  | 限制大小 | 指定返回记录的数量，系统会做验证 | int | 否 | 50 |
| offset  | 偏移量 | 指定返回记录的开始位置  | int  | 否 | 0 |
...
###20.***配件商报价列表***
**接口说明**：配件商查看已经报价的询价信息汇总。
**请求资源**：/accessory-shop/quotation-sheet-lists
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/accessory-shop/quotation-sheet-lists
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求资源**：/purchase-order
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/purchase-order
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| quotation_sheet_id | 报价单编号 | 系统返回的报价单ID  | int | 是 | -|
...
| quotation_sheet_accessory_item_id | 报价配件编号 | 系统返回的报价配件ID  | int | 是 | -|
| number| 数量| 采购配件数量|  int | 是 | - |
...
###22.***维修厂采购单详情***
**接口说明**： 维修厂看到自己的采购单详情页面
**请求资源**：/motor-repair-shop/purchase-order-detail
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/motor-repair-shop/purchase-order-detail
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| :-------- | :--------| :-- |:--------|--------:| --------:|
| access_token  | 维修厂账户Token | 维修厂账户授权Token | string  | 是 | 无 |
| order_id | 采购单编号| 系统返回的采购单ID  | int | 是 | -|


**请求实例**：
```json
http://api.weipei.cc/v1/motor-repair-shop/purchase-order-detail?access_token=3e16cdaa0061ee89106b9112890a419397b46f1s&order_id=1
```
**返回结果**：
```json
{
...
**请求资源**：/user
**请求方式**：PUT
**请求地址**：http://api.weipei.cc/v1/user
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求资源**：/token_login
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/token_login
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求资源**：/unfavorite
**请求方式**：PUT
**请求地址**：http://api.weipei.cc/v1/unfavorite
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求资源**：/upload-request
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/upload-request
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求资源**：/motor-repair-shop/quotation-sheet-detail
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/motor-repair-shop/quotation-sheet-detail
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| :-------- | :--------| :-- |:--------|--------:| --------:|
| access_token  | 服务商账户Token | 服务商账户授权Token | string  | 是 | 无 |
| quotation_sheet_id  | 报价单编号 | 系统返回的报价单编号  | int  | 是 | 无 |
...
**请求资源**：/accessory-shop/quotation-sheet-detail
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/accessory-shop/quotation-sheet-detail
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| :-------- | :--------| :-- |:--------|--------:| --------:|
| access_token  | 配件商账户Token | 配件商账户授权Token | string  | 是 | 无 |
| inquiry_sheet_id  | 询价单编号 | 系统返回的询价单编号  | int  | 是 | 无 |
...
|appearance|车型外观图| string| -|
|vin|vin图| int| -|
|status|状态, 0待处理 2已报价 4已结束| int| -|
|status_string|状态说明 | string| -|
|created_at|创建时间 | string| -|
|exipiry_time|过期时间|int|10|
|server_time|服务器当前时间戳|int|10|
|updated_at|更新时间|string|-|
|total_quoted|总共报价|int|-|
|motor_repair_shop_id|维修厂编号| int| -|
|motor_repair_shop_address|维修厂详细地址| string| -|
|motor_repair_shop_name|维修厂名称| string| -|
|motor_repair_shop_contact|维修厂联系人| string| -|
...
| 参数名      |含义   | 规则说明  | 参数类型 | 是否必须 | 缺省值 |
| :-------- | :--------| :-- |:--------|--------:| --------:|
| quotation_sheet_id  | 报价单系统编号 | 报价单系统编号 | int  | 是 | 无 |
| access_token  | 配件商账户Token | 配件商账户授权Token | string  | 是 | 无 |
| inquiry_sheet_id | 询价单编号 | 系统返回询价ID  | int | 是 | -|
| quotation_sheet_items | 报价条目 | 报价条目  | -| - | -|
| quotation_sheet_accessory_item_id | 已报价配件编号| 已报价配件编号   | int  | 是 | 无 |
| inquiry_sheet_accessory_item_id | 询价配件编号| 询价配件编号    | int  | 是 | 无 |
| accessory_item_id | 配件编号| 系统返回的配件编号    | int  | 是 | 无 |
| inquiry_sheet_accessory_items | 配件条目| 配件条目   |-  |- | - |
| price | 价格  | 报价价格，支持两位小数  | float  | 是 | 无 |
...
| 参数名      |含义   | 规则说明  | 参数类型 | 是否必须 | 缺省值 |
| :-------- | :--------| :-- |:--------|--------:| --------:|
| inquiry_sheet_id  |  询价单系统编号 | 询价单系统编号 | int  | 是 | 无 |
| access_token  | 服务商账户Token | 服务商账户授权Token | string  | 是 | 无 |
| automobile_brand  | 品牌编号 | 系统返回的品牌ID  | int  | 是 | 无 |
| automobile_series  | 车系编号 | 系统返回的车系ID  | int  | 是 | 无 |
| automobile_model  | 车型编号 | 系统返回的车型ID  | int  | 是 | 无 |
...
| notes  | 备注  | 备注信息  | string  | 否 | 无 |
| accessory_item | 配件条目编号  | 正常情况是填写配件类目ID,  如果不是ID, 请传入配件名称  | string | 否 | 无 |
| inquiry_sheet_accessory_item_id | 已询价的配件系统编号 | 已询价的配件系统编号  | int | 否 | 无 |
| accessory_item_image | 配件图片  | 配件附件ID,请先走上传图片接口  | int | 否 | 无 |
| accessory_shop_ids  | 配件商ID  | 修理厂指定哪些配件商,多个请用逗号分隔，例如：2,4,5| string  | 否 | 无 |
...
###35.***修理厂结束询价***
**接口说明**：修理厂取消询价信息
**请求资源**：/motor-repair-shop/inquiry-sheet-end
**请求方式**：PUT
**请求地址**：http://api.weipei.cc/v1/motor-repair-shop/inquiry-sheet-end
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
|inquiry_sheet  | 询价单编号| 系统返回的询价单编号  | int | 是 | 无 |
...
###36.***修理厂采购单列表***
**接口说明**： 修理厂查询采购单信息
**请求资源**：/motor-repair-shop/purchase-order-lists
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/motor-repair-shop/purchase-order-lists
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| :-------- | :--------| :-- |:--------|--------:| --------:|
| access_token  | 服务商账户Token | 服务商账户授权Token | string  | 是 | 无 |
| status  | 采购单状态| 0待发货 1已发货 2已关闭 3全部 | int  | 否 | 3 |
| limit  | 限制大小 | 指定返回记录的数量，系统会做验证 | int | 否 | 100 |
| offset  | 偏移量 | 指定返回记录的开始位置  | int  | 否 | 0 |
...
**请求实例**：
```json
http://api.weipei.cc/v1/motor-repair-shop/purchase-order-lists?access_token=3e16cdaa0061ee89106b9112890a419397b4613s&limit=100&offset=0&status=3
```
**返回结果**：
```json
{
    ...
    "purchase_order_list": [
        {
            "purchase_order": {
                "order_id": 1,
                "order_no": "5579402d79342",
                "order_status_string": "待发货",
                "order_status": 0,
                "order_price": 12,
                "order_invoice": "http://img.dev.weipei.cc/Uploads/pictures/assets/226bdccde7e8e.jpg",
                "created_at": "2015-06-11 16:00:45",
                "shippment_time": "2015-06-11 16:00:45",
                "inquiry_sheet_id": 1,
                "automobile_brand_name": "宝马",
                "automobile_series_name": "威赛帝(进口)",
                "automobile_model_name": "宝马 3系(进口) 2013款 2013款 2.0T 2.0T 手自一体 手自一体 GT 320i 风尚设计套装"
            },
            "order_receipt": {
                "consignee": "描述",
                "mobile": "18615788190",
...
###37.***配件商采购单列表***
**接口说明**： 配件商查询采购单信息
**请求资源**：/accessory-shop/purchase-order-lists
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/accessory-shop/purchase-order-lists
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求实例**：
```json
http://api.weipei.cc/v1/accessory-shop/purchase-order-lists?access_token=3e16cdaa0061ee89106b9112890a419397b4613s&limit=100&offset=0&status=3
```
**返回结果**：
```json
{
...
| :-------- | :--------| :-- |:--------|--------:| --------:|
| access_token  | 授权token | 授权token   | sring  | 是 | 无 |
| order_id  | 采购单编号 | 系统返回的采购单ID  | int | 是 | 无 |
...
**请求资源**：/invitation/code
**请求方式**：PUT
**请求地址**：http://api.weipei.cc/v1/invitation/code
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| :-------- | :--------| :-- |:--------|--------:| --------:|
| access_token  | 授权token | 授权token   | sring  | 是 | 无 |
| invite_code  | 邀请码 | 系统生成的邀请码  | int | 是 | 无 |
...
|account_role|账号角色,1-配件商 2-修理厂|int|-|
|id|修理厂或者配件商编号|int|-|
...
**请求资源**：/realname
**请求方式**：PUT
**请求地址**：http://api.weipei.cc/v1/realname
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求资源**：/auto-brands
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/auto-brands
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36

**请求实例**：
```http
http://api.weipei.cc/v1/auto-brands
```
**返回结果**：
```json
{ 
...
**请求资源**：/auto-series
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/auto-series
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求实例**：
```http
http://api.weipei.cc/v1/auto-series?brand_id=10
```
**返回结果**：
```json
{ 
...
**请求资源**：/auto-models
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/auto-models
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求实例**：
```http
http://api.weipei.cc/v1/auto-models?auto_series_id=1
```
**返回结果**：
```json
{ 
...
**请求资源**：/provinces
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/provinces
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36

**请求实例**：
```http
http://api.weipei.cc/v1/provinces
```
**返回结果**：
```json
{ 
...
**请求资源**：/cities
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/cities
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**: 
...
**请求资源**：/accessories/attributes
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/accessories/attributes
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
...
**请求实例**：
```http
http://api.weipei.cc/v1/accessories/attributes?access_token=MmI3MTBhNGEyZTM0YjVmOTY5MjFmYzljNzI4NDI5MTA=
```
**返回结果**：
```json
{ 
...
**请求资源**：/accessory-shop/shipments
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/accessory-shop/shipments
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
| :-------- | :--------| :-- |:--------|--------:| --------:|
| access_token  | 配件商账户Token | 配件商账户授权Token | string  | 是 | 无 |
| order_id  | 采购单编号| 系统返回的采购单编号 | int  | 是 | 无 |
| invoince  | 发货单照片编号| 系统返回的发货单照片编号 | int  | 是 | 无 |
...
**请求资源**：/accessory-shop/invitation
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/accessory-shop/invitation
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：

| 参数名      |含义   | 规则说明  | 参数类型 | 是否必须 | 缺省值 |
| :-------- | :--------| :-- |:--------|--------:| --------:|
| accessory_shop_id  | 配件商系统编号 |配件商系统编号 |int  | 是 | 无 |
| bd  | BD人员系统编号 | BD人员系统编号 | int  | 是 | 无 |
...
**请求资源**：/motor-repair-shop/invitation
**请求方式**：POST
**请求地址**：http://api.weipei.cc/v1/motor-repair-shop/invitation
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：

| 参数名      |含义   | 规则说明  | 参数类型 | 是否必须 | 缺省值 |
| :-------- | :--------| :-- |:--------|--------:| --------:|
| motor_repair_shop_id  | 修理厂系统编号 |修理厂系统编号 |int  | 是 | 无 |
| bd  | BD人员系统编号 | BD人员系统编号 | int  | 是 | 无 |
...
**请求资源**：/accessory-shop/purchase-order-detail
**请求方式**：GET
**请求地址**：http://api.weipei.cc/v1/accessory-shop/purchase-order-detail
**HTTP请求头**：Authorization:8e16cdaa0061ee89106b9112890a419397b46f36
**请求参数**：
...
**请求实例**：
```json
http://api.weipei.cc/v1/accessory-shop/purchase-order-detail?access_token=3e16cdaa0061ee89106b9112890a419397b46f1s&order_id=1
```
**返回结果**：
```json
{
...
| 参数名      |含义   | 规则说明  | 参数类型 | 是否必须 | 缺省值 |
| :-------- | :--------| :-- |:--------|--------:| --------:|
| motor_repair_shop_id  | 维修厂编号 | 系统返回的维修厂ID  | int  | 是 | 无 |
